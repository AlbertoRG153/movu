...
import { MoveIcon as MovingTruck, Truck, TruckIcon, MapPinIcon, InfoIcon, PhoneIcon } from "lucide-react"
  ...
  const services = [
    {
      ...
      description: "Servicio de mudanza para hogares y oficinas con personal altamente calificado y equipos modernos.",
    },
    {
      title: "Fletes",
      icon: <Truck className="h-16 w-16 text-emerald-400" />,
      description: "Transporte de mercancías y paquetería con seguimiento en tiempo real y garantía de seguridad.",
    },
    {
      title: "Material de construcción",
      icon: <TruckIcon className="h-16 w-16 text-emerald-400" />,
      description: "Entrega puntual de materiales para construcción adaptada a tus necesidades específicas.",
    },
  ]
    ...
    <main className="flex min-h-screen flex-col bg-gradient-to-b from-white to-emerald-50">
      ...
      <section ref={heroRef} className="relative h-[80vh] overflow-hidden">
        ...
        >
          ...
          >
            <Button 
              className="bg-emerald-500 hover:bg-emerald-600 text-white font-medium px-8 py-3 rounded-full transition-all duration-300 hover:shadow-lg hover:shadow-emerald-500/30 cursor-pointer"
            >
              ¡Comienza Ahora!
            </Button>
          </motion.div>
      ...
      >
        <motion.p 
          ...
          variants={fadeInUp}
        >
          En <span className="text-emerald-600 font-semibold">Movu</span>, revolucionamos el transporte de fletes, mudanzas y materiales con una plataforma flexible y
        ...
        >
          <motion.div
            ...
            whileTap={{ scale: 0.98 }}
          >
            <Link href="#" className="inline-block transition-transform cursor-pointer">
              <Image
                src="/googleplay.svg"
                alt="Google Play"
                width={180}
      ...
      >
        <div className="max-w-6xl mx-auto">
          <motion.div 
            ...
            viewport={{ once: true }}
          >
            <h2 className="text-3xl font-bold text-gray-800 mb-4">Ciudades Disponibles</h2>
            <p className="text-gray-600 max-w-2xl mx-auto">Movu está disponible en las principales ciudades de Honduras, brindando servicios de transporte confiables y eficientes.</p>
          </motion.div>
      ...
      >
        ...
        <div className="max-w-6xl mx-auto relative z-10">
          ...
          >
            <p className="text-emerald-100/70">Soluciones de transporte adaptadas a tus necesidades, con la mejor calidad y compromiso</p>
          </motion.div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            >
              ...
              <p className="text-gray-600 mb-6">
                Así surgió Movu en 2024, la primera aplicación hondureña especializada exclusivamente en fletes y mudanzas, diseñada para 
                reducir los tiempos de espera en un 40% y aumentar la frecuencia de viajes de los transportistas en un 50%. Con un sistema 
                de verificación de conductores, seguimiento en tiempo real y una plataforma de pagos integrada, Movu no solo revolucionó 
                la logística local sino que se posicionó como una promesa de expansión regional, captando rápidamente el interés del 85% 
                de transportistas y clientes potenciales encuestados, y abriendo nuevas oportunidades económicas en un sector 
              ...
              <div className="grid grid-cols-2 gap-6">
                <div className="flex items-center">
                  ...
                  <div>
                    <h4 className="font-bold text-gray-800">Misión</h4>
                    <p className="text-sm text-gray-600">Transformar el transporte de cargas</p>
                  </div>
                </div>
      ...
      >
        <div className="max-w-4xl mx-auto px-4">
          ...
          <motion.p 
            ...
            viewport={{ once: true }}
          >
            Miles de personas y empresas ya confían en Movu para sus necesidades de transporte y logística.
            Descubre cómo podemos ayudarte a simplificar tus envíos y mudanzas con nuestra plataforma innovadora.
          </motion.p>
