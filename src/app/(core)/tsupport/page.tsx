        ...
        <div className="bg-white rounded-xl p-6 shadow-lg">
          <div className="mb-6">
            ...
            <div className="space-y-4">
              <Link href="/tsupport/city" className="flex items-center justify-between py-2">
                <span className="text-gray-700">Ciudad</span>
                <ChevronRight className="h-5 w-5 text-gray-400" />
              </Link>

              <Link href="/tsupport/delivery" className="flex items-center justify-between py-2">
                <span className="text-gray-700">Entregas</span>
                <ChevronRight className="h-5 w-5 text-gray-400" />
              </Link>

              <Link href="/tsupport/freight" className="flex items-center justify-between py-2">
          ...
          <div>
            ...
            <div className="space-y-4">
              <Link href="/tsupport/problem" className="flex items-center justify-between py-2">
                <span className="text-gray-700">Problemas con la aplicación</span>
                <ChevronRight className="h-5 w-5 text-gray-400" />
              </Link>

              <Link href="/tsupport/about" className="flex items-center justify-between py-2">
