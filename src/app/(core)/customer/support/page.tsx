...
export default function SupportCustomerPage() {
  return (
        ...
        <div className="bg-white rounded-xl p-6 shadow-lg mt-3">
          <div className="mb-6">
            ...
            <div className="space-y-4">
              <Link href="/customer/support/city" className="flex items-center justify-between py-2">
                <span className="text-gray-700">Ciudad</span>
                <ChevronRight className="h-5 w-5 text-gray-400" />
              </Link>
              <Link href="/customer/support/freight" className="flex items-center justify-between py-2">
          ...
          <div>
            ...
            <div className="space-y-4">
              <Link href="/customer/support/problem" className="flex items-center justify-between py-2">
                <span className="text-gray-700">Problemas con la aplicación</span>
                <ChevronRight className="h-5 w-5 text-gray-400" />
              </Link>

              <Link href="/customer/support/about" className="flex items-center justify-between py-2">
